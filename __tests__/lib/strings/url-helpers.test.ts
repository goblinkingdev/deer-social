...
describe('linkRequiresWarning', () => {
  ...
  const cases: Case[] = [
    ...
    ['http://site.vercel.app', 'http://site.page', true],
    ['http://site.page', 'http://site.vercel.app', true],
    ['http://site.vercel.app', 'site.page', true],
    ['http://site.page', 'site.vercel.app', true],
    ['http://site.vercel.app', 'http://site.pages', true],
    ['http://site.pages', 'http://site.vercel.app', true],
    ['http://site.vercel.app', 'site.pages', true],
    ['http://site.pages', 'site.vercel.app', true],
